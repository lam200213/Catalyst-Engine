#!/bin/bash
# run_backend_tests.sh - A script to run pytest in all backend services.
...
# --- Script Logic ---
# Run the script with an optional argument: ./run_backend_tests.sh --fail-fast for Efficient Debugging
